 ...
 */
public class ActivityMeusJogosListAdapter extends BaseAdapter  {

    private Context context;
    private List<Jogo> lista;
    private View.OnClickListener tela;

    public ActivityMeusJogosListAdapter(Context context, List lista, View.OnClickListener tela){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.listameusjogos_model, null);
        ...
        ImageView imageView = (ImageView) view.findViewById(R.id.crossView);
